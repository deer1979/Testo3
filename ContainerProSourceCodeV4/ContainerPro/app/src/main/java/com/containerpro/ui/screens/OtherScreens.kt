...
fun ModelSelectScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                stringResource(R.string.model_select_sub),
            ...
            listOf(
                stringResource(R.string.ml3_section) to ml3Models,
                stringResource(R.string.ml5_section) to ml5Models,
                ...
                Surface(
                    ...
                    Column {
                        models.forEach { model ->
                            ...
                            Row(
                                modifier  = Modifier.fillMaxWidth().clickable { selected = model }.padding(16.dp),
...
fun ServiceCheckScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        bottomBar = {
            Surface(color = MaterialTheme.colorScheme.surface) {
                Button(
                    ...
                    Spacer(Modifier.width(8.dp))
                    Text(stringResource(R.string.complete_service), fontWeight = FontWeight.Bold)
                }
            }
        },
    ) { p ->
        Column(
            ...
            Text(
                "$done / $total ${stringResource(R.string.items_completed)}",
                style    = MaterialTheme.typography.labelSmall,
                color    = MaterialTheme.colorScheme.onSurfaceVariant,
            ...
            categories.forEach { (cat, items) ->
                ...
                Surface(
                    ...
                    Column {
                        items.forEach { item ->
                            Row(
                                modifier  = Modifier.fillMaxWidth().clickable { checked[item] = !(checked[item] ?: false) }.padding(14.dp),
                                verticalAlignment     = Alignment.CenterVertically,
                                horizontalArrangement = Arrangement.SpaceBetween,
                            ) {
